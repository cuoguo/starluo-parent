 ...
 */
@Data
public class FortuneDetailFullRO implements java.io.Serializable {
    ...
    private double health;                // 健康指数
    private String lucky_color;           // 幸运颜色
    private int lucky_number;             // 幸运数字
    private String speed_dating;          // 速配星座

    private String fortune_tips;          // 运势贴士
